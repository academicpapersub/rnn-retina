...
class CNNModel(nn.Module):
    def __init__(self):
        ...
        #self.conv1_3 = Conv2d(64, 64, kernel_size=1, stride=1, padding=0, bias=False)
        ...
        #self.conv2_3 = Conv2d(128, 128, kernel_size=1, stride=1, padding=0, bias=False)
        ...
        #self.conv3_3 = Conv2d(256, 256, kernel_size=1, stride=1, padding=0, bias=False)
        ...
        #self.conv4_3 = Conv2d(512, 512, kernel_size=1, stride=1, padding=0, bias=False)
        #self.conv4_4 = Conv2d(512, 512, kernel_size=3, stride=1, padding=1, bias=False)

        '''self.conv5_1 = Conv2d(512, 512, kernel_size=3, stride=1, padding=1, bias=False)
        self.conv5_2 = Conv2d(512, 512, kernel_size=3, stride=1, padding=1, bias=False)
        self.conv5_3 = Conv2d(512, 512, kernel_size=3, stride=1, padding=1, bias=False)'''
